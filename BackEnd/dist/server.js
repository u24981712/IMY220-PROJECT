...
function _connectToMongo() {
  _connectToMongo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee23() {
    var _t21;
    return _regenerator().w(function (_context23) {
      while (1) switch (_context23.p = _context23.n) {
        ...
        case 2:
          _context23.p = 2;
          _t21 = _context23.v;
          console.error('Error connecting to MongoDB:', _t21);
          throw _t21;
        case 3:
...
app.get('/downloadFile/:projectName/:fileName', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var _req$params, projectName, fileName, email, project, file, fileBuffer, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 4:
          _context3.p = 4;
          _t3 = _context3.v;
          console.error('Download error:', _t3);
          res.status(500).json({
...
app.post('/deleteFile', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var _req$body, projectName, fileName, email, result, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 4:
          _context4.p = 4;
          _t4 = _context4.v;
          console.error('Delete file error:', _t4);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 2:
          _context5.p = 2;
          _t5 = _context5.v;
          console.error('Error reading Users.json:', _t5);
          res.status(500).json({
...
app.get('/getProject/:projectName', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
    var projectName, email, project, _t6;
...
app.post('/newProject', /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(req, res) {
    var _req$body2, projectName, email, existingProject, date, dateOnly, projectData, result, _t8;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        case 0:
          _context8.p = 0;
          // FIRST CHECK IF A PROJECT WITH THE SAME NAME BY THE SAME USER EXISTS
          _req$body2 = req.body, projectName = _req$body2.projectName, email = _req$body2.email; // const existingProject = await DATABASE.collection(projectsCollection).findOne({
          //   email: email,
          //   projectName: projectName
          // });
          _context8.n = 1;
...
app.post('/deleteProject', /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(req, res) {
    var _req$body3, projectName, email, result, _t9;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        case 0:
          _context9.p = 0;
          _req$body3 = req.body, projectName = _req$body3.projectName, email = _req$body3.email; // if (!projectName || !email) {
        ...
        case 3:
          _context9.p = 3;
          _t9 = _context9.v;
          console.error('Delete error: ', _t9);
          res.status(500).json({
    ...
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        ...
        case 2:
          _context0.p = 2;
          _t0 = _context0.v;
          console.error('Error reading Users.json:', _t0);
          res.status(500).json({
            error: 'Failed to retreive projects'
          });
        case 3:
    ...
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        ...
        case 4:
          _context1.p = 4;
          _t1 = _context1.v;
          console.error('Error fetching user:', _t1);
          res.status(500).json({
...
app.post("/signup", /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(req, res) {
    var newUser, email, user, confirmpassword, userToSave, _t11;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        ...
        case 5:
          _context11.p = 5;
          _t11 = _context11.v;
          console.error('Error creating user:', _t11);
          res.status(500).json({
...
app.post('/sendFriendRequest', /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(req, res) {
    var _req$body4, email, receiverEmail, receiver, sender, friendRequests, followers, result, _t13;
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        case 0:
          _context13.p = 0;
          _req$body4 = req.body, email = _req$body4.email, receiverEmail = _req$body4.receiverEmail;
        ...
        case 5:
          ...
          return _context13.a(2, res.json({
...
app.post('/acceptFriendRequest', /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(req, res) {
    var _req$body5, currentUserEmail, requesterEmail, user, requester, session, _t14;
    return _regenerator().w(function (_context15) {
      while (1) switch (_context15.p = _context15.n) {
        case 0:
          _context15.p = 0;
          _req$body5 = req.body, currentUserEmail = _req$body5.currentUserEmail, requesterEmail = _req$body5.requesterEmail;
        ...
        case 7:
          ...
          _context15.p = 8;
          _context15.n = 9;
          return session.withTransaction(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
...
app.post('/declineFriendRequest', /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(req, res) {
    var _req$body6, currentUserEmail, requesterEmail, user, friendRequests, result, _t15;
    return _regenerator().w(function (_context16) {
      while (1) switch (_context16.p = _context16.n) {
        case 0:
          _context16.p = 0;
          _req$body6 = req.body, currentUserEmail = _req$body6.currentUserEmail, requesterEmail = _req$body6.requesterEmail;
          if (!(!currentUserEmail || !requesterEmail)) {
            _context16.n = 1;
            break;
          }
        ...
        case 7:
          _context16.p = 7;
          _t15 = _context16.v;
          console.error('Error declining friend request:', _t15);
          res.status(500).json({
...
app.put('/updateUser', /*#__PURE__*/function () {
  var _ref17 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee17(req, res) {
    var userData, email, _id, updateData, result, updatedUser, _t16;
    return _regenerator().w(function (_context17) {
      while (1) switch (_context17.p = _context17.n) {
        ...
        case 5:
          _context17.p = 5;
          _t16 = _context17.v;
          console.error('Error updating user:', _t16);
          res.status(500).json({
...
app["delete"]('/deleteProfile', /*#__PURE__*/function () {
  var _ref18 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(req, res) {
    var email, user, session, _t17, _t18, _t19;
    return _regenerator().w(function (_context19) {
      while (1) switch (_context19.p = _context19.n) {
        ...
        case 10:
          _context19.p = 10;
          _t19 = _context19.v;
          console.error('Error deleting profile:', _t19);
          res.status(500).json({
...
var findOneProject = /*#__PURE__*/function () {
  var _ref21 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee21(email, projectName) {
    var Project;
    return _regenerator().w(function (_context21) {
      while (1) switch (_context21.n) {
        ...
        case 1:
          Project = _context21.v;
          return _context21.a(2, Project);
      }
    }, _callee21);
  }));
  return function findOneProject(_x39, _x40) {
    return _ref21.apply(this, arguments);
  };
}();
var findManyProject = /*#__PURE__*/function () {
  var _ref22 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee22(email) {
    var Projects;
    return _regenerator().w(function (_context22) {
      while (1) switch (_context22.n) {
        ...
        case 1:
          Projects = _context22.v;
          return _context22.a(2, Projects);
      }
    }, _callee22);
  }));
  return function findManyProject(_x41) {
...
function _startServer() {
  _startServer = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee24() {
    var _t22;
    return _regenerator().w(function (_context24) {
      while (1) switch (_context24.p = _context24.n) {
        ...
        case 2:
          _context24.p = 2;
          _t22 = _context24.v;
          console.error('Failed to start server:', _t22);
        case 3:
