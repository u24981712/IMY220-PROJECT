...
function _connectToMongo() {
  _connectToMongo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee28() {
    var _t26;
    return _regenerator().w(function (_context28) {
      while (1) switch (_context28.p = _context28.n) {
        ...
        case 2:
          _context28.p = 2;
          _t26 = _context28.v;
          console.error("Error connecting to MongoDB:", _t26);
          throw _t26;
        case 3:
...
app.get("/getFileContent/:projectName/:fileName", /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(req, res) {
    var _req$params2, projectName, fileName, email, project, file, fileBuffer, fileContent, _t11;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        case 0:
          _context11.p = 0;
          _req$params2 = req.params, projectName = _req$params2.projectName, fileName = _req$params2.fileName;
          email = req.query.email;
          _context11.n = 1;
          return DATABASE.collection(projectsCollection).findOne({
        ...
        case 2:
          file = project.files.find(function (f) {
            return f.fileName === decodeURIComponent(fileName);
          });
          if (file) {
            _context11.n = 3;
            break;
        ...
        case 4:
          _context11.p = 4;
          _t11 = _context11.v;
          console.error("Get file content error:", _t11);
          res.status(500).json({
...
app.post("/deleteProject", /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(req, res) {
    var _req$body6, projectName, email, result, _t12;
    ...
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        ...
        case 2:
          _context13.p = 2;
          _t13 = _context13.v;
          console.error("Error reading Users.json:", _t13);
          res.status(500).json({
            error: "Failed to retreive projects"
          });
        case 3:
    ...
    return _regenerator().w(function (_context14) {
      while (1) switch (_context14.p = _context14.n) {
        ...
        case 4:
          _context14.p = 4;
          _t14 = _context14.v;
          console.error("Error fetching user:", _t14);
          res.status(500).json({
...
app.post("/signup", /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(req, res) {
    var newUser, email, user, confirmpassword, userToSave, _t16;
    return _regenerator().w(function (_context16) {
      while (1) switch (_context16.p = _context16.n) {
        ...
        case 5:
          _context16.p = 5;
          _t16 = _context16.v;
          console.error("Error creating user:", _t16);
          res.status(500).json({
...
app.post("/sendFriendRequest", /*#__PURE__*/function () {
  var _ref18 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee18(req, res) {
    var _req$body7, email, receiverEmail, receiver, sender, friendRequests, followers, result, _t18;
    return _regenerator().w(function (_context18) {
      while (1) switch (_context18.p = _context18.n) {
        ...
        case 5:
          ...
          return _context18.a(2, res.json({
        ...
        case 10:
          _context18.p = 10;
          _t18 = _context18.v;
          console.error("Error sending friend request:", _t18);
          res.status(500).json({
...
app.post("/acceptFriendRequest", /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee20(req, res) {
    var _req$body8, currentUserEmail, requesterEmail, user, requester, session, _t19;
    return _regenerator().w(function (_context20) {
      while (1) switch (_context20.p = _context20.n) {
        ...
        case 7:
          ...
          _context20.p = 8;
          _context20.n = 9;
          return session.withTransaction(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19() {
        ...
        case 12:
          _context20.p = 12;
          _t19 = _context20.v;
          console.error("Error accepting friend request:", _t19);
          res.status(500).json({
...
app.post("/declineFriendRequest", /*#__PURE__*/function () {
  var _ref21 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee21(req, res) {
    var _req$body9, currentUserEmail, requesterEmail, user, friendRequests, result, _t20;
    return _regenerator().w(function (_context21) {
      while (1) switch (_context21.p = _context21.n) {
        ...
        case 7:
          _context21.p = 7;
          _t20 = _context21.v;
          console.error("Error declining friend request:", _t20);
          res.status(500).json({
...
app.put("/updateUser", /*#__PURE__*/function () {
  var _ref22 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee22(req, res) {
    var userData, email, _id, updateData, result, updatedUser, _t21;
    return _regenerator().w(function (_context22) {
      while (1) switch (_context22.p = _context22.n) {
        ...
        case 5:
          _context22.p = 5;
          _t21 = _context22.v;
          console.error("Error updating user:", _t21);
          res.status(500).json({
...
app["delete"]("/deleteProfile", /*#__PURE__*/function () {
  var _ref23 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee24(req, res) {
    var email, user, session, _t22, _t23, _t24;
    return _regenerator().w(function (_context24) {
      while (1) switch (_context24.p = _context24.n) {
        ...
        case 3:
          ...
          _context24.p = 4;
          _context24.n = 5;
          return session.withTransaction(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee23() {
        ...
        case 10:
          _context24.p = 10;
          _t24 = _context24.v;
          console.error("Error deleting profile:", _t24);
          res.status(500).json({
...
var findOneProject = /*#__PURE__*/function () {
  var _ref26 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee26(email, projectName) {
    var Project;
    return _regenerator().w(function (_context26) {
      while (1) switch (_context26.n) {
        ...
        case 1:
          Project = _context26.v;
          return _context26.a(2, Project);
      }
    }, _callee26);
  }));
  return function findOneProject(_x49, _x50) {
    return _ref26.apply(this, arguments);
  };
}();
var findManyProject = /*#__PURE__*/function () {
  var _ref27 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee27(email) {
    var Projects;
    return _regenerator().w(function (_context27) {
      while (1) switch (_context27.n) {
        ...
        case 1:
          Projects = _context27.v;
          return _context27.a(2, Projects);
      }
    }, _callee27);
  }));
  return function findManyProject(_x51) {
...
function _startServer() {
  _startServer = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee29() {
    var _t27;
    return _regenerator().w(function (_context29) {
      while (1) switch (_context29.p = _context29.n) {
        ...
        case 2:
          _context29.p = 2;
          _t27 = _context29.v;
          console.error("Failed to start server:", _t27);
        case 3:
